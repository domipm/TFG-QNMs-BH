...
axes[0].set_title(r"Parte real $\text{Re}(\omega_n)$")
axes[1].set_title(r"Parte imaginaria $\text{Im}(\omega_n)$")

axes[1].yaxis.tick_right()

#axes[0].set_ylabel(r"Frecuencia quasinormal $\omega_n$")
#axes[1].set_ylabel(r"Error iterativo $\log_{10}(\varepsilon_{\text{Re}(\omega_n)})$")

axes[0].set_xlabel(r"Momento angular $\ell$")
axes[1].set_xlabel(r"Momento angular $\ell$")

axes[0].legend()
axes[1].legend()

plt.savefig("schw_llimit.pdf", bbox_inches="tight")
plt.show()
