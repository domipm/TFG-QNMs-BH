...
data = np.loadtxt("aim_err.txt", skiprows=1)
...
axes[0].set_ylim(10**-10, 10**3)
axes[1].set_ylim(10**-10, 10**3)
...
axes[0].set_ylabel(r"Error iterativo $\varepsilon_{\omega_n}$ [%]")
...
plt.savefig("error_new.pdf", bbox_inches="tight")
plt.show()
