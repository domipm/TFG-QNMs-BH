...
data = np.loadtxt("belowone.txt", skiprows=0)
...
ax_im.plot(data[::s,0], data[::s,8], label=r"$\omega_3$", marker="", linestyle=":", markersize=4, linewidth=0.75)
...
ax_re.set_ylim(-0.05,0.75)
ax_im.set_ylim(-1.05,0.05)
...
ax_re.set_title(r"Región de pseudo-convergencia $(y_0\ll 0)$ Regge-Wheeler")

plt.savefig("belowone_four.pdf", bbox_inches="tight")
plt.show()