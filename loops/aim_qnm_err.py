...
class aim_solver(object):
    ...
    def iaim_display(self, sols, display_all, n, n_modes = 15, parsed=False):
        ...
        #   Write first 4 modes into file
        try:
            file.write( str(float(mp.re(sols_sorted[0] ))) + "\t" + str( float(mp.im(sols_sorted[0])) ) + "\t" + str(float(mp.re(sols_sorted[1] ))) + "\t" + str( float(mp.im(sols_sorted[1])) ) + "\t" + str(float(mp.re(sols_sorted[2] ))) + "\t" + str( float(mp.im(sols_sorted[2])) ) + "\t" + str(float(mp.re(sols_sorted[3] ))) + "\t" + str(float(mp.im(sols_sorted[3] ))) + "\n")
        except:
            try:
                file.write( str(float(mp.re(sols_sorted[0] ))) + "\t" + str( float(mp.im(sols_sorted[0])) ) + "\t" + str(float(mp.re(sols_sorted[1] ))) + "\t" + str( float(mp.im(sols_sorted[1])) ) + "\t" + str(float(mp.re(sols_sorted[2] ))) + "\t" + str(float(mp.im(sols_sorted[2] ))) + "\tnan\tnan\n")
            except:
                try:
                    file.write( str(float(mp.re(sols_sorted[0] ))) + "\t" + str( float(mp.im(sols_sorted[0])) ) + "\t" + str(float(mp.re(sols_sorted[1] ))) + "\t" + str(float(mp.im(sols_sorted[1] ))) + "\tnan\tnan\tnan\tnan\n")
                except:
                    try:
                        file.write( str(float(mp.re(sols_sorted[0] ))) + "\t" + str(float(mp.im(sols_sorted[0] ))) + "\tnan\tnan\tnan\tnan\tnan\tnan\n")
                    except:
