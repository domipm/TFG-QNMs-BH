...
class aim_solver(object):
    ...
    def __init__(self, lambda_0, s_0, x, x0, n_iter, l_mom): 
    ...
    def iaim_display(self, sols, display_all, n, n_modes = 15, parsed=False):
        ...
        try:
            file.write( str(round(self.l_mom)) + "\t" + str(float(mp.re(sols_sorted[0] ))) + "\t" + str( float(mp.im(sols_sorted[0])) ) + "\t" + str(float(mp.re(sols_sorted[1] ))) + "\t" + str( float(mp.im(sols_sorted[1])) ) + "\t" + str(float(mp.re(sols_sorted[2] ))) + "\t" + str( float(mp.im(sols_sorted[2])) ) + "\t" + str(float(mp.re(sols_sorted[3] ))) + "\t" + str( float(mp.im(sols_sorted[3])) ) + "\t" + str(float(mp.re(sols_sorted[4] ))) + "\t" + str( float(mp.im(sols_sorted[4])) ) + "\n" )
        except:
            try:
                file.write( str(round(self.l_mom)) + "\t" + str(float(mp.re(sols_sorted[0] ))) + "\t" + str( float(mp.im(sols_sorted[0])) ) + "\t" + str(float(mp.re(sols_sorted[1] ))) + "\t" + str( float(mp.im(sols_sorted[1])) ) + "\t" + str(float(mp.re(sols_sorted[2] ))) + "\t" + str( float(mp.im(sols_sorted[2])) ) + "\t" + str(float(mp.re(sols_sorted[3] ))) + "\t" + str( float(mp.im(sols_sorted[3])) ) + "\tnan\tnan\n"  )
            except:
                try:
                    file.write( str(round(self.l_mom)) + "\t" + str(float(mp.re(sols_sorted[0] ))) + "\t" + str( float(mp.im(sols_sorted[0])) ) + "\t" + str(float(mp.re(sols_sorted[1] ))) + "\t" + str( float(mp.im(sols_sorted[1])) ) + "\t" + str(float(mp.re(sols_sorted[2] ))) + "\t" + str( float(mp.im(sols_sorted[2])) ) + "\tnan\tnan\tnan\tnan\n"  )
                except:
                    try:
                        file.write( str(round(self.l_mom)) + "\t" + str(float(mp.re(sols_sorted[0] ))) + "\t" + str( float(mp.im(sols_sorted[0])) ) + "\t" + str(float(mp.re(sols_sorted[1] ))) + "\t" + str( float(mp.im(sols_sorted[1])) ) + "\tnan\tnan\tnan\tnan\tnan\tnan\n"  )
                    except:
                        try:
                            file.write( str(round(self.l_mom)) + "\t" + str(float(mp.re(sols_sorted[0] ))) + "\t" + str( float(mp.im(sols_sorted[0])) ) + "\tnan\tnan\tnan\tnan\tnan\tnan\tnan\tnan\n"  )
                        except: 
                            file.write( str(round(self.l_mom)) + "\tnan\tnan\tnan\tnan\tnan\tnan\tnan\tnan\tnan\tnan\n"  )
